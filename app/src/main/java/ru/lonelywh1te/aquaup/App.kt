...
import ru.lonelywh1te.aquaup.di.coreModule
...
class App: Application() {
    ...
    private val crashlytics: FirebaseCrashlytics by inject<FirebaseCrashlytics>()
    ...
    override fun onCreate() {
        ...
        Timber.plant(if (BuildConfig.DEBUG) Timber.DebugTree() else ExceptionReportingTree(crashlytics))
